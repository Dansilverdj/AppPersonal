            ...
            <div className="grid lg:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="space-y-6 mb-8">
                  <div>
                    ...
                    <p className={`${tc.text} leading-relaxed`}>Gestión manual, fugas de dinero por accesos no autorizados y falta de claridad financiera en la operación diaria.</p>
                  </div>
                  <div>
                    ...
                    <p className={`${tc.text} leading-relaxed`}>
                      Desarrollo de una <strong>Aplicación de Gestión Integral</strong>. Incluye control biométrico de acceso, punto de venta (POS) para tienda y dashboard financiero en tiempo real.
                    </p>
                  </div>
                </div>
              ...
              <div className={`p-4 md:p-8 ${theme === 'dark' ? 'bg-slate-800/50' : 'bg-slate-100'} flex flex-col gap-4 justify-center`}>
                 <div className="rounded-xl overflow-hidden shadow-2xl border border-slate-700 relative group aspect-video">
                    ...
                    <img src="/finance.png" alt="Finanzas Dashboard" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                 </div>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="rounded-xl overflow-hidden shadow-lg border border-slate-700 relative group aspect-video">
                       ...
                       <img src="/pos.png" alt="Tienda POS" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                    </div>
                    <div className="rounded-xl overflow-hidden shadow-lg border border-slate-700 relative group aspect-video">
                       ...
                       <img src="/access.png" alt="Control Acceso" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                    </div>
                 </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2">
              ...
              <div className={`p-4 md:p-8 ${theme === 'dark' ? 'bg-slate-800/50' : 'bg-slate-100'} flex flex-col gap-4 justify-center order-2 lg:order-1`}>
                 <div className="rounded-xl overflow-hidden shadow-2xl border border-slate-700 relative group aspect-video">
                    ...
                    <img src="/brand-main.png" alt="Manual de Identidad Corporativa" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                 </div>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="rounded-xl overflow-hidden shadow-lg border border-slate-700 relative group aspect-video">
                       ...
                       <img src="/brand-vehicle.png" alt="Mockup Transporte" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                    </div>
                    <div className="rounded-xl overflow-hidden shadow-lg border border-slate-700 relative group aspect-video">
                       ...
                       <img src="/brand-stationery.png" alt="Mockup Papelería" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                    </div>
                 </div>
              </div>
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center order-1 lg:order-2">
                ...
                <div className="space-y-6 mb-8">
                  <div>
                    <h4 className={`text-sm font-bold uppercase tracking-wider mb-2 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'}`}>El Reto</h4>
                    <p className={`${tc.text} leading-relaxed`}>Empresas de logística comercial y firmas de consultoría legal/fiscal que operaban con una imagen desactualizada, restando peso y profesionalismo al momento de negociar con corporativos de alto nivel.</p>
                  </div>
                  <div>
